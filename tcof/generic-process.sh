...
find ./$1 -name "Adultes*$3" -exec sh ../commands/tocsv_line.sh {} ADU ADULTES tocsv_line_$2 \; | sort >> stat-$1.csv
find ./$1 -name "Enfants_Long*$3" -exec sh ../commands/tocsv_line.sh {} ADU LONG tocsv_line_$2 \; | sort >> stat-$1.csv
find ./$1 -name "Enfants_Trans*$3" -exec sh ../commands/tocsv_line.sh {} ADU TRANS tocsv_line_$2 \; | sort >> stat-$1.csv
find ./$1 -name "Enfants_Entretiens*$3" -exec sh ../commands/tocsv_line.sh {} ADU PHI tocsv_line_$2 \; | sort >> stat-$1.csv
