...
java -cp ../divers/teicorpo.jar fr.ortolang.teicorpo.TeiCorpo -to CLAN NouveauxNoms/tei_corpo -normalize clan -o NouveauxNoms/clan -rawline -target clan
...
java -cp ../divers/teicorpo.jar fr.ortolang.teicorpo.TeiCorpo NouveauxNoms/clan -o NouveauxNoms/tei_corpo3 | tee erreurs_conversion.log

# génère l'analyse en parties du discours TTG
java -cp ../divers/teicorpo.jar fr.ortolang.teicorpo.TeiTreeTagger -syntaxformat ref -program /brainstorm/syntax/bin/tree-tagger -model /brainstorm/syntax/models/french-spoken.par NouveauxNoms/tei_corpo3 -target ttg | tee erreurs_ttg_perceo.log
...
rm -rf NouveauxNoms/ttg_perceo_clan
mkdir NouveauxNoms/ttg_perceo_clan
java -cp ../divers/teicorpo.jar fr.ortolang.teicorpo.TeiCorpo -to CLAN NouveauxNoms/ttg_perceo -normalize clan -o NouveauxNoms/ttg_perceo_clan -rawline -target clan
