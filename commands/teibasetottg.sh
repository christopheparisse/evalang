...
java -cp ../../evalang/commands/teicorpo.jar fr.ortolang.teicorpo.TeiTreeTagger -syntaxformat ref -program ../../evalang/commands/tree-tagger-macos-m1 -model ../../evalang/commands/french-spoken.par ./tei_corpo_base -target perceo | tee erreurs_ttg_perceo.log
